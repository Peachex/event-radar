...
function display_ascii_art() {
    module_name=$1
    case $module_name in
        "sync-task-scheduler-ui")
            cat <<'EOF'
                              _            _                    _              _       _                        _ 
                             | |          | |                  | |            | |     | |                      (_)
  ___ _   _ _ __   ___ ______| |_ __ _ ___| | ________ ___  ___| |__   ___  __| |_   _| | ___ _ __ ______ _   _ _ 
 / __| | | | '_ \ / __|______| __/ _` / __| |/ /______/ __|/ __| '_ \ / _ \/ _` | | | | |/ _ \ '__|______| | | | |
 \__ \ |_| | | | | (__       | || (_| \__ \   <       \__ \ (__| | | |  __/ (_| | |_| | |  __/ |         | |_| | |
 |___/\__, |_| |_|\___|       \__\__,_|___/_|\_\      |___/\___|_| |_|\___|\__,_|\__,_|_|\___|_|          \__,_|_|
       __/ |                                                                                                      
      |___/                                                                                                       
...
EOF
        ...
        "event-web-app-ui")
            cat <<'EOF'
                       _                       _                                        _ 
                      | |                     | |                                      (_)
   _____   _____ _ __ | |_ ________      _____| |__ ______ __ _ _ __  _ __ ______ _   _ _ 
  / _ \ \ / / _ \ '_ \| __|______\ \ /\ / / _ \ '_ \______/ _` | '_ \| '_ \______| | | | |
 |  __/\ V /  __/ | | | |_        \ V  V /  __/ |_) |    | (_| | |_) | |_) |     | |_| | |
  \___| \_/ \___|_| |_|\__|        \_/\_/ \___|_.__/      \__,_| .__/| .__/       \__,_|_|
                                                               | |   | |                  
                                                               |_|   |_|                                                                                                       
EOF
            ;;
...
services=("sync-task-scheduler-ui" "event-web-app-ui")
