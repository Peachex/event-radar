package by.klevitov.eventpersistor.persistor.factory;

import by.klevitov.eventpersistor.persistor.converter.EntityConverter;
import by.klevitov.eventpersistor.persistor.converter.impl.AfishaRelaxEventConverter;
import by.klevitov.eventpersistor.persistor.converter.impl.ByCardEventConverter;
...
import static by.klevitov.eventpersistor.persistor.constant.PersistorExceptionMessage.ENTITY_CONVERTER_NOT_FOUND;
