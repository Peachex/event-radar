...
public final class PersistorExceptionMessage {
    ...
    public static final String NULL_OR_EMPTY_RAW_ADDRESSOR_LOCATION_NAME = "Location address/name cannot be null or empty.";
    public static final String LOCATION_ALREADY_EXISTS = "Location with address: '%s', name: '%s' already exists. "
            + "Location id: '%s'.";
